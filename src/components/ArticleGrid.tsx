import { type Article, TOPICS, TOPIC_COLORS } from "@/lib/constants";
...
// ── Newspaper section: 1 hero + grid of default cards ───────────────────────
...
const GroupedView = ({ articles, onTopicClick, t }: GroupedViewProps) => {
  ...
  const topicDefs = TOPICS.filter((topic) => topic.label !== "All Topics");
  ...
  if (sections.length === 0) return <NewspaperSection articles={fallback} />;
